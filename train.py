...
def train_pipeline(root_path):
    ...
    # ---------------------------------------------------------
    # WARNING: should not use get_root_logger in the above
    # codes, including the called functions Otherwise the
    # logger will not be properly initialized
    # ---------------------------------------------------------
    ...
    for epoch in range(start_epoch, total_epochs):
        ...
        while train_data is not None:
            ...
            if current_iter % opt['val']['val_freq'] == 0:
                ...
                if model.is_best:
                    logger.info('This is a new best record. Saving model and training state.')
