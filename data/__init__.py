...
def build_dataset(dataset_opt):
    ...
    elif dataset_type in ['Dataset_Maxim']:
        from data.image_datasets import Dataset_Maxim as D

    elif dataset_type in ['Dataset_GaussianDenoising']:
        from data.image_datasets import Dataset_GaussianDenoising as D

    elif dataset_type in ['Dataset_Maxim_GaussianDenoising']:
        from data.image_datasets import Dataset_Maxim_GaussianDenoising as D

    elif dataset_type in ['Dataset_Dehaze']:
        from data.image_datasets import Dataset_Dehaze as D
